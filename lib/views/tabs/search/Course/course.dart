...
class _CoursePageState extends State<CoursePage> {
  ...
  Widget build(BuildContext context) {
    return Consumer<Auth>(builder: (ctx, auth, child) {
      List<String> list = List.from(auth.currentUser.followed_courses);
      print(list);
      return Scaffold(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    RaisedButton(
                      ...
                      onPressed: () {
                        List<dynamic> list = auth.currentUser.followed_courses;
                        if (!list.contains(widget.courseName +
                            "/" +
                            ...
                            widget.courseLab +
                            "*" +
                            widget.courseCredit.toString())) {
                          list.add(widget.courseName +
                              "/" +
                              widget.numb.toString() +
                              "++" +
                              widget.courseId +
                          ...
                          Firestore.instance
                              ...
                              .updateData({"followed_courses": list});
                          addFollow();
                        } else {
                          print(list);
                          followError();
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              color:
                                  !isReview ? Color(0xffCBD2D4) : Colors.white,
                              borderRadius:
